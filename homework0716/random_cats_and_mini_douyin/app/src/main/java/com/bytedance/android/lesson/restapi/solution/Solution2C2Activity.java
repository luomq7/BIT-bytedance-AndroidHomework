...
public class Solution2C2Activity extends AppCompatActivity {
    ...
    List<retrofit2.Call<PostVideoResponse>> poscallList = new ArrayList<>();
    ...
    public void fetchFeed(View view) {
        ...
        retrofit2.Call<FeedResponse> feedResponseCall = NetworkUtils.getResponseWithRetrofitAsyncOffeedResponse();
        feedcallList.add(feedResponseCall);
