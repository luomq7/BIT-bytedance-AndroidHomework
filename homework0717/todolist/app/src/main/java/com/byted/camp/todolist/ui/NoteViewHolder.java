...
//        itemView.setBackgroundColor((getColor(note.getPriority())));
        itemView.setBackgroundColor(contentText.getResources().getColor(note.getPriority().intColor));
    }
//    public int getColor(Priority priority){
//        int color = contentText.getResources().getColor(priority.intColor);
//        return color;
//    }
}
